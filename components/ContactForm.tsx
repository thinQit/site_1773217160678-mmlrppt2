...
export default function ContactForm({
  headline = 'Contact Us',
  subheadline = 'Ask about training plans, class schedules, or your free trial.',
  contactInfo = [],
          ...
          <Card className="border-border bg-card card-hover">
            <CardContent className="p-6">
              <form className="space-y-6">
                ...
                <Button type="submit" variant="destructive" className="w-full transition-all duration-200 hover:scale-105 uppercase">
                  Send Message
                </Button>
              </form>
            </CardContent>
              ...
              {contactInfo.map(function (info, i) {
                return (
                  <div key={i} className="flex items-start gap-4">
                    <span className="text-2xl text-destructive">{info.icon}</span>
                    <div>
